...
export function cacheModulesArr(settingsSheetIdStr?: string) {
  const spreadsheetId =
    typeof settingsSheetIdStr === "string"
      ? settingsSheetIdStr
      : PropertiesService.getScriptProperties().getProperty("settingsSheetId");
